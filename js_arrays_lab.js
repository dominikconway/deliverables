...
// foods.push("soup") is this problem right?
...
let odds = []
//ex: if the remainder of 100 / 2 is not equal to 0 then add that number to the end of the array
